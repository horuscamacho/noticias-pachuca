#!/usr/bin/env node
/**
 * Script para crear usuarios en PRODUCCIÓN
 *
 * Uso:
 * MONGODB_URI="..." node scripts/create-user-production.js
 *
...
// Configuración del usuario a crear - PRODUCCIÓN
const USER_DATA = {
  email: 'camachohorus@gmail.com',
  username: 'sinhue',
...
if (!MONGO_URI) {
  console.error('❌ ERROR: Variable de entorno MONGODB_URI no está configurada');
  console.error('   Uso: MONGODB_URI="..." node scripts/create-user-production.js');
  process.exit(1);
}
...
async function createUser() {
  ...
  try {
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    console.log('🎉 Ahora puedes iniciar sesión en el backoffice:\n');
    console.log('   URL:      https://backoffice.noticiaspachuca.com');
    console.log(`   Email:    ${newUser.email}`);
    console.log(`   Password: ${USER_DATA.password}`);
    console.log('');
